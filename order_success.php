...
<section class="home" id="home" onmouseover="play()" onmousemove="play()" onmouseenter="play()" onmouseout="play">
    ...
    <div class="content">
		<h3  onmouseover="play()" onmousemove="play()" onmouseenter="play()" onmouseout="play" style="padding-top: 50px;"><a href="#"  onmouseover="play()" onmousemove="play()" onmouseenter="play()" onmouseout="play" class="neon-button"  style="font-size: 30px;!important">Order Confirmed</a></h3>
        <p style="color: darkgrey;">Food is on the way!</p>
		
		<p><img src="images/mrkrabsmoney.png" style="width: 200px; height: 200px; cursor: pointer;"></p>
		<p>Don't forget to pay the extra charges</p>
        <a href="UserHome.php" class="btn">Return Home</a>
    </div>
	...
	<audio id="myAudio" loop>
	  <source src="spongebob_theme_music.mp3" type="audio/ogg">
...
<div class="loader-container">
    <img src="images/foodloader.gif" alt="">
</div>
