...
<body onload="play()" onmouseover="play()" onmousemove="play()" onmouseenter="play()" onmouseout="play">
...
<header  onmouseover="play()" onmousemove="play()" onmouseenter="play()" onmouseout="play" onmouseout="play">
    ...
    <nav class="navbar">
        <a href="#">home</a>
        <a href="PhpLogin.php">menu</a>
        <a href="PhpLogin.php">About</a>
        <a href="PhpLogin.php">Reservation</a>
        <a href="PhpLogin.php">Review</a>
        <a href="PhpLogin.php">order</a>
    </nav>
...
<section class="home" id="home" onmouseover="play()" onmousemove="play()" onmouseenter="play()" onmouseout="play">
    ...
    <div onload="play()" class="content">
        ...
        <a href="PhpLogin.php" class="btn">order now</a>
    </div>
